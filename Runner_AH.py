...
runs = [["base=medium", "logger=adroit_hammer", "model=adroit_hammer_lstm900", "data=adroit_hammer"],
        ["base=medium", "logger=adroit_hammer", "model=adroit_hammer_lstm1200", "data=adroit_hammer"],
        ["base=medium", "logger=adroit_hammer", "model=adroit_hammer_lstm1500", "data=adroit_hammer"]]
